...
module.exports = function(app) {
    ...
    app.get('/user/:uId/interactions/news', [controllers.newInteractions, controllers.getInteractionsOfUser]);
    app.get('/user/:uId/interactions/', controllers.getInteractionsOfUser);
